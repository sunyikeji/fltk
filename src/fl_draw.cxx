...
#endif
    if (fl_gbktest(str)) { //ÅÐ¶ÏÊÇ·ñÓÐGBK±àÂëÖÐÎÄ×Ö·û
      if (fl_utf8test(str,strlen(str)) <= 1) { //ÅÐ¶ÏÊÇ·ñUTF-8±àÂë
        str2 = fl_locale_to_utf8(str, strlen(str), 936); //×ª»»ÖÐÎÄ±àÂëGBKµ½UTF-8
#ifdef DEBUG
